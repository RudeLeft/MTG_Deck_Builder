...
| `mtgdb/database/search_queries.py` | `SearchQueryBuilder`, canonical parameterized search SQL over precomputed columns (content_kind, colour bitmasks) and type/subtype/keyword membership tables, projection validation, stable `CardDB.search()` implementation |
